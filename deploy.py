# -*- coding: utf-8 -*-
"""
Created on Thu Nov 10 16:46:18 2022
...
claimants = pd.read_csv('https://raw.githubusercontent.com/slmsshk/DataSet/main/claimants.csv',delimiter=',')
st.write(claimants.columns)


claimants.drop(claimants.columns[0],axis=1)
